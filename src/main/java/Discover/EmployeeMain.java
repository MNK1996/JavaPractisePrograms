...
//        Print the number of employees in each department using streams program.

        System.out.println(empList.stream().collect(Collectors.groupingBy(Employee::getHr, Collectors.counting())));
